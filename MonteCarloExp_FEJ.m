...
for mc = 1:mcNum
    ...
    for k = 0:poseNum
        ...
        if k == 0
            ...
            % The result of displaying GNI as a singular matrix is due
            % to the fact that the R2Xp0 randomly generated by adding 
            % noise falls on the true value of the feature
