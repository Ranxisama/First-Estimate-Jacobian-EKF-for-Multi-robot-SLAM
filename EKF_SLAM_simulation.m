        ...
        if realTimeCheck == 1
            ...
            if CovCheck == 1
                ...
                legendEntries1 = legend('true R1 pose','true R2 pose','true feature', ...
                    'estimated R1 pose','estimated R2 pose','estimated features', ...
                    'Cov ellipse of estimated R1 pose','Cov ellipse of estimated R2 pose', 'Cov ellipse of estimated features');
                legendStrings = legendEntries1.String;

            else
                legendEntries2 = legend('true R1 pose','true R2 pose','true feature', ...
                    'estimated R1 pose','estimated R2 pose','estimated features');
                legendStrings = legendEntries2.String;

            end
            legend(legendStrings)
            title(sprintf('step %d with %d features after GNI',k,size(X0,1)-6))
