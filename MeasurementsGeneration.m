...
R2Obs = observationGeneration(R2XrTrue,R2XphiT,R2PosNum,XfTrueAll,R1addObsNoise,R2R,R2sensorRange);
...
save('Measurements.mat','R1Xp0','R1Odo','R1Obs','R2Odo','R2Obs')